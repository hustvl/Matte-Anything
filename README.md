...
MatAny could get matting results as *RGBA images*. It will be saved into ```your_demos/your_demo.png```. You can specify the saving name of it in our UI. We hope that MatAny can truly help you, even if it's just a small part of your life.
